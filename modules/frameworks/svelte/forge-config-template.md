...
| fg-410-architecture-reviewer | true | secondary | Architecture violations — findings merged into quality-gate |
...
| fg-414-frontend-a11y-reviewer | true | secondary | WCAG 2.2 AA compliance for SPA components |
