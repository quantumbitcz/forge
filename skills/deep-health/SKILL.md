...
| `forge:fg-417-dependency-reviewer` | Dependency files changed (package.json, build.gradle.kts, go.mod, etc.) |
| `forge:fg-419-infra-deploy-reviewer` | Infra files present (Dockerfile, helm, k8s manifests) |
| `forge:fg-417-dependency-reviewer` | Dependency manifests present |
