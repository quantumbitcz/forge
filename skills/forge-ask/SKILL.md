...
**Source 3 — Explore Cache (`.forge/explore-cache/`)**

1. Check if `.forge/explore-cache/` directory exists.
...
**Source 4 — Docs Index (`.forge/docs-index/` or project docs)**

1. Check if `.forge/docs-index/` exists (generated by docs-generate skill).
