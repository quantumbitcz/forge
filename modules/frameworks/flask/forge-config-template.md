...
| fg-411-security-reviewer | true | elevated | Flask session/CSRF/debug-mode foot-guns warrant elevated scrutiny |
| fg-416-performance-reviewer | true | secondary | N+1 from Flask-SQLAlchemy lazy load, before_request cost |
