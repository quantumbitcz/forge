...
- `/forge-review` -- Full codebase scan against convention rules including security patterns
- `/forge-review` -- Iteratively fix all codebase issues including security findings
