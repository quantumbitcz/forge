...
|------|----------------|--------|
| 1 | tasks + ask + plan_mode | fg-010-shaper, fg-200-planner, fg-160-migration-planner, fg-050-project-bootstrapper, fg-090-sprint-orchestrator |
...
| 3 | tasks only | fg-300-implementer, fg-320-frontend-polisher, fg-700-retrospective, fg-130-docs-discoverer, fg-140-deprecation-refresh, fg-650-preview-validator, infra-deploy-verifier, fg-310-scaffolder, fg-350-docs-generator, fg-250-contract-validator, fg-150-test-bootstrapper |
