...
# ---------------------------------------------------------------------------
# 2. Schema version is "1.2.0"
# ---------------------------------------------------------------------------
@test "state-schema: schema version 1.2.0 documented" {
  grep -q '"version": "1.2.0"' "$STATE_SCHEMA" \
    || fail 'Schema version "1.2.0" not found in state-schema.md'
}
