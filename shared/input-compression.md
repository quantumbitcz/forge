...
Per-file compression system that reduces input tokens in agent system prompts, convention stacks, and config templates. Applied offline via `/forge-compress` — not runtime post-processing.
