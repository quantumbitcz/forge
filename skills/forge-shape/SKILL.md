...
1. **Parse input**: The user's argument (everything after `/forge-shape`) is the feature idea — a free-text description like "Add notification system" or "I want users to share plans".

2. **Dispatch the shaper**: Use the Agent tool to invoke `fg-010-shaper` with the following prompt:
