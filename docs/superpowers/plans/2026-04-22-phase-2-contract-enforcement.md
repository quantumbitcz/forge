...
agents/                                         # Edited: 13 files + 2 reviewer-timeouts bats edits
  ...
  fg-205-plan-judge.md                          # + ui: block (Tier 4)
...
- Modify: `/Users/denissajnar/IdeaProjects/forge/agents/fg-205-plan-judge.md`
...
- [ ] **Step 3: Insert ui: block into fg-205-plan-judge.md**
  Same block. Justified as Tier 4 per `agents/fg-205-plan-judge.md:4` ("silent adversarial plan reviewer"). The ui:tasks=false/ask=false/plan_mode=false triple matches that role — the judge never talks to the user, never creates tasks, never enters plan mode.
...
- [ ] **Step 9: Squash-commit Tasks 3+4 together**
  ...
  git add agents/fg-101-worktree-manager.md agents/fg-102-conflict-resolver.md \
          agents/fg-205-plan-judge.md agents/fg-410-code-reviewer.md \
