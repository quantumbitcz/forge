...
Users run `/docs-generate --confirm-decisions` for interactive review. Options: upgrade, keep, dismiss.
...
| No documentation found | INFO | "fg-130: No docs found. Index empty. Run /docs-generate for baseline." |
