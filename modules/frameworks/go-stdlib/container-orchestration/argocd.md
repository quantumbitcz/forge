# ArgoCD with Go stdlib

> Extends `modules/container-orchestration/argocd.md` with Go stdlib GitOps deployment patterns.
...
spec:
  project: default
  source:
    repoURL: https://github.com/org/go-app-deploy
    targetRevision: main
    path: helm/go-app
  destination:
...
- DO use Image Updater for promotion
- DO configure `selfHeal: true`

## Additional Don'ts

- DON'T put secrets in Git
- DON'T auto-sync production without approval
