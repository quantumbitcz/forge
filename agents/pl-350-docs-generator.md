...
# Documentation Generator (pl-350)
...
**Pipeline mode:** All file writes go to `.pipeline/worktree/`. Never write directly to the consuming project's working tree during pipeline runs. Read source files from the worktree path; fall back to the project root for files not yet in the worktree.
...
Mark every auto-generated section with: `<!-- generated by dev-pipeline docs-generator -->`
...
1. **Written files** — updated/created docs in `.pipeline/worktree/`
2. **Stage notes** — write `.pipeline/stage_7_notes_{storyId}.md`:
...
- DO NOT write to the working tree in pipeline mode — use `.pipeline/worktree/` only
- DO NOT invent API endpoints, entity fields, or architectural decisions not present in the source
- DO NOT mark user-authored content as `<!-- generated by dev-pipeline docs-generator -->`
